		    ...
		    <div class="utility noprint  dark-bar">
				<div class="utility-commerce">
					<ul id="header-utils" class="commerce-utils">
                        ...
                        <li><a href="{{route('programming')}}">PROGRAMACIÓN ({{ $orderProgrammerViews->count($customer_id) }})</a></li>
		            ...
		            <div class="js-search-form search-form" hidden id="searchForm">
			            <form method="get" action="{{route('search-products',$params)}}" formid="header-searchform" name="header-searchform" class="hasrequired header-search">
			...
			<ul class="top-level-subnav shop-nav">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px; z-index:3; position:absolute">
                            <ul style="height: 443px;">
                                ...
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'cocina','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                ...
                                <li style="" class="bottomlvl-cat-header default-li-selected" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'lavanderia','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'closets','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 800px;">
                            <ul style="height: 800px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'herramienta','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 550px;">
                            <ul style="height: 550px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'automotriz','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                ...
                <li id="cat160024" class="trigger-subnav-category trigger-subnav-category-float">
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 950px;">
                            <ul style="height: 950px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'ferreteria','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'impulso','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 650px;">
                            <ul style="height: 650px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'electrico','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 460px;">
                            <ul style="height: 460px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'pintura','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'jardin','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 480px;">
                            <ul style="height: 480px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'limpieza','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'iluminacion','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 500px;">
                            <ul style="height: 500px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'plomeria','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'ventilacion','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'exterior','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'mantenimiento','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'material contruccion','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'outdoor','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
					...
					<div class="subnav-category-text parent-li" style="">
                        ...
                        <div class="bottomlvl-cat-header-wrapper child-li border border-secondary" style="visibility: hidden; height: 443px;">
                            <ul style="height: 443px;">
                                @foreach($subcategories as $subcategory)
                                <li style="" class="bottomlvl-cat-header" id="cat160024-cat1481016" data-catid="cat1481016">
                                    <a class="text-capitalize" href="{{route('category-products',['slug' => 'chapas','child' => $subcategory->slug])}}">{{$subcategory->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
