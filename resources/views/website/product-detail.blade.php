        ...
        <div id="main-body">
            <div id="" class="row">
                <div id="" class="col-md-12 form-inline">
                    <div class="col-md-5 ml-5 grid__item two-thirds">
                    ...
                    <div id="js-pdp-desc" class="col-md-6">
                        <div id="js-pdp-desc-wrapper" class="col-md-12 pdp__desc__inner-wrapper">
                ...
                <div class="container" id="line-items">
                    <h3 class="pdp__line-item__display-name--core js-item-product-name ml-3 mt-5"> ARTICULOS SIMILARES</h3>
                    <hr/>
                    @foreach($related_products as $r_product)
                        <div class="col-md-12 form-inline" id="lineitem-prod2170124" data-productid="prod2170124" data-is-cog="true" data-sku-id="cog-sku3480003" data-full-sku-id="57070708 CLCH" data-colorizable="true">
                            <div class="col-md-12">
                                <div class="col-md-5 grid__item one-sixth">
                                    <div class="js-line-item__image">
                                        <img class="pdp__line-item__thumbnail lazy" src="{{$r_product->image}}" alt="{{$r_product->name}}">
                                    </div>
                                </div>
                                <div class="col-md-7 grid__item five-sixths">
