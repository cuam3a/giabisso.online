                ...
                @if($products->count()>0)
                        ...
                        <div class="grid__item one-third product-cell__container" style="height:450px">
							<div class="product-cell--plain" data-productid="prod7750078" data-type="" data-skuid="" data-swatchid="" >
	                            <a name="prod7750078" href="{{ route('product-detail-JAT', ['id' => $product->id,'slug' => $product->slug]) }}">
                                    <div class="product-cell__image-container--plain">
				                        <div class="product-cell__inset-container" style="position:relative">
							                <img class="lazy product-cell__img--plain js-product-cell__img" data-original="" data-alt-img="" src="{{$product->image}}" alt="" style="display: inline;">
		                                </div>
			                        </div>
			                    </a>
                            </div>
