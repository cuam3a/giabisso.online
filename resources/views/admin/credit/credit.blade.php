...
<form class="frmRefunds" action="{{ route("admin-config-credit-save") }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                ...
                <div class="m-portlet__head" style="border:none!important">
                    <div class="m-portlet__head-caption" style="border-bottom: 1px solid #ebedf2;">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">
                                Valores de Credito predefinidos
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="m-portlet__body row">
                    <div class="form-group col-md-6">
                            <label class="label">Credito</label>
                            <input type="number" name="credit" id="credit" class="form-control col-md-12"
                            value="{{ $credit }}" placeholder="Ingrese aquí"/>
                    </div>
                    <div class="form-group col-md-6">
                            <label class="label">Dias de Credito</label>
                            <input type="number" name="credit_days" id="credit_days" class="form-control col-md-12"
                            value="{{ $credit_days }}" placeholder="Ingrese aquí"/>
                    </div>
                </div>
