        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a id="btn-save-faq" class="m-btn m-btn--pill m-btn--hover-brand btn btn-sm btn-secondary">Guardar</a>	
                </li>
            </ul>
        </div>
    </div>
</div>
<form class="frmFaq" action="{{ route("admin-add-faq-save") }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group">
                            <input type="hidden" value="{{ $faq->id }}" class="form-control m-input" name="id">
                            <input type="numbers" name="title" id="title" class="form-control" style="width:100%"
                            value="{{ $faq->title or old('title') }}" placeholder="Ingrese aquí"/>
                    </div>
                </div>
                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group">
                            <textarea class="summernote-es" name="content" id="content">{{ $faq->content or old('content') }}</textarea>
                    </div>
                </div>
...
<script>
    var Config = [];
    $(function() {
        $("#btn-save-faq").on("click",function(){
            $(".frmFaq").submit();
        });
