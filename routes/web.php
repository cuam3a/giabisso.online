...
Route::middleware(["Visitas","restore_cart"])->prefix('/')->group(function () {
    ...
    Route::get('/ofertas', [ 'as'                       => 'offers-products', 'uses' => 'WebsiteController@offersList']);//GCUAMEA
    ...
    Route::get('/jat/concepto', [ 'as'                       => 'concepto-JAT', 'uses' => 'WebsiteController@conceptoJAT']);//GCUAMEA
    Route::get('/jat/nosotros', [ 'as'                       => 'nosotros-JAT', 'uses' => 'WebsiteController@nosotrosJAT']);//GCUAMEA
    Route::get('/jat/politica-precios', [ 'as'                       => 'politica-precios-JAT', 'uses' => 'WebsiteController@politica_preciosJAT']);//GCUAMEA
    Route::get('/jat/ventajas', [ 'as'                       => 'ventajas-JAT', 'uses' => 'WebsiteController@ventajasJAT']);//GCUAMEA
    Route::get('/jat/beneficios', [ 'as'                       => 'beneficios-JAT', 'uses' => 'WebsiteController@beneficiosJAT']);//GCUAMEA
    Route::get('/jat/contacto', [ 'as'                       => 'contacto-JAT', 'uses' => 'WebsiteController@contactoJAT']);//GCUAMEA
    Route::get('/jat/liquidacion', [ 'as'                       => 'settlement-products-JAT', 'uses' => 'WebsiteController@settlementListJAT']);//GCUAMEA
    Route::get('/jat/producto/{id}/{slug}', [ 'as'        => 'product-detail-JAT', 'uses' => 'WebsiteController@productDetailJAT']);
    Route::group([ 'prefix'                           => '/jat/tienda'], function () {
        Route::get('/', [ 'as'                 => 'search-products-JAT', 'uses' => 'WebsiteController@categoryListJAT']);    
        Route::get('/{slug?}/{child?}', [ 'as' => 'category-products-JAT', 'uses' => 'WebsiteController@categoryListJAT']);
        //Route::get('/liquidacion/{liq?}', [ 'as' => 'settlement-products', 'uses' => 'WebsiteController@settlementList']);   
    });
    ...
    Route::group([ 'prefix'                           => '/mi-cuenta', 'namespace' => 'Customer'], function () {
        ...
        Route::post('/solicitud-producto','CustomerController@sendRequestProduct')->name('send-request-product');//GCUAMEA
        Route::get('/detalle-programacion/{order}','CustomerController@programmingDetail')->name('programming-detail');
    });


    Route::post('/jat/mi-cuenta#devoluciones',['as'       => 'my-account-tab-refunds-jat']);
    Route::group([ 'prefix'                           => '/jat/mi-cuenta', 'namespace' => 'Customer'], function () {
        //Customer        
        Route::get('olvide-contrasena', [ 'as'            => 'forgot-password', 'uses' => 'LoginController@showForgotPasswordForm']);
        Route::post('contrasena/email', 'LoginController@sendResetLinkEmail')->name('send-reset-link-email');
        Route::match(['get','post'], '/recuperar-password/{email}/{token}', 'LoginController@recoverPassword')->name('recover-password-customer');
        Route::get('/ingresar', [ 'as'                    => 'website-login-jat', 'uses' => 'LoginController@loginJAT']);
        Route::get('/', [ 'as'                            => 'my-account-jat', 'uses' => 'CustomerController@myAccountJAT']);
        Route::post('/nuevo-usuario', [ 'as'              => 'new-customer', 'uses' => 'LoginController@newCustomer']);
        Route::get('/ingresar-usuario', 'LoginController@signInCustomerJAT')->name('signin-customer-jat');
        Route::get('/cerrar-sesion', 'LoginController@logoutCustomer')->name('logout-customer');
        Route::get('/actualizar-favoritos/{product}', 'CustomerController@updateFavorites')->name('update-favorites');    
        Route::post('/guardar-direccion', 'CustomerController@saveAddress')->name('save-customer-address');    
        Route::get('/eliminar-direccion/{id}', 'CustomerController@delAddress')->name('del-customer-address');    
