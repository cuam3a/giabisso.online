...
(function($) {
    ...
    Iconpicker.DEFAULTS = {
        ...
        arrowNextIconClass: "la la-angle-right",
        arrowPrevIconClass: "la la-angle-left",
        cols: 4,
        icon: "la la-bars",
        iconset: "lineawesome",
        ...
        return this.each(function() {
            ...
            if (typeof option === 'string') {
                ...
                if ($this.prop('tagName') === 'BUTTON') {
                    $this
                        .empty()
                        .append('<i class="la la-caret-down"></i>')
                        .append('<input type="hidden" ' + name + " name='icon'></input>")
