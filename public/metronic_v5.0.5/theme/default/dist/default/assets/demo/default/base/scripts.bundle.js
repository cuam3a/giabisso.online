var mApp = function() {
    var e = function(e) {
            ...
            e.tooltip({ trigger: "hover", template: '<div class="m-tooltip ' + t + ' tooltip" role="tooltip">                <div class="arrow"></div>                <div class="tooltip-inner"></div>            </div>' })
        },
        t = function() { $('[data-toggle="m-tooltip"]').each(function() { e($(this)) }) },
        a = function(e) {
            var t = e.data("skin") ? "m-popover--skin-" + e.data("skin") : "";
            e.popover({ trigger: "hover", template: '            <div class="m-popover ' + t + ' popover" role="tooltip">                <div class="arrow"></div>                <h3 class="popover-header"></h3>                <div class="popover-body"></div>            </div>' })
        },
        n = function() { $('[data-toggle="m-popover"]').each(function() { a($(this)) }) },
        o = function(e, t) { e.mPortlet(t) },
        i = function() { $('[data-portlet="true"]').each(function() { var e = $(this);!0 !== e.data("portlet-initialized") && (o(e, {}), e.data("portlet-initialized", !0)) }) };
    return {
        init: function() { mApp.initComponents() },
        initComponents: function() {
            ...
            }), t(), n(), $("body").on("click", "[data-close=alert]", function() { $(this).closest(".alert").hide() }), i()
        },
        initTooltips: function() { t() },
        initTooltip: function(t) { e(t) },
        initPopovers: function() { n() },
        initPopover: function(e) { a(e) },
        initPortlet: function(e, t) { o(e, t) },
        initPortlets: function() { i() },
        ...
        initScroller: function(e, t) { mUtil.isMobileDevice() ? e.css("overflow", "auto") : (e.mCustomScrollbar("destroy"), e.mCustomScrollbar({ scrollInertia: 0, autoDraggerLength: !0, autoHideScrollbar: !0, autoExpandScrollbar: !1, alwaysShowScrollbar: 0, axis: e.data("axis") ? e.data("axis") : "y", mouseWheel: { scrollAmount: 120, preventDefault: !0 }, setHeight: t.height ? t.height : "", theme: "minimal-dark" })) },
        destroyScroller: function(e) { e.mCustomScrollbar("destroy") },
        alert: function(e) {
            e = $.extend(!0, { container: "", place: "append", type: "success", message: "", close: !0, reset: !0, focus: !0, closeInSeconds: 0, icon: "" }, e);
        ...
        block: function(e, t) {
            ...
            var r = { message: html, centerY: t.centerY, centerX: t.centerX, css: { top: "30%", left: "50%", border: "0", padding: "0", backgroundColor: "none", width: t.width }, overlayCSS: { backgroundColor: t.overlayColor, opacity: t.opacity, cursor: "wait" }, onUnblock: function() { i && (i.css("position", ""), i.css("zoom", "")) } };
            if ("body" == e) r.css.top = "50%", $.blockUI(r);
            else {
                (i = $(e)).block(r)
            }
        },
        unblock: function(e) { e && "body" != e ? $(e).unblock() : $.unblockUI() },
        blockPage: function(e) { return mApp.block("body", e) },
...
var mUtil = function() {
    var e = [],
        ...
        a = { brand: "#716aca", metal: "#c4c5d6", light: "#ffffff", accent: "#00c5dc", primary: "#5867dd", success: "#34bfa3", info: "#36a3f7", warning: "#ffb822", danger: "#f4516c" },
        n = function() {
            var t;
            jQuery(window).resize(function() { t && clearTimeout(t), t = setTimeout(function() {! function() { for (var t = 0; t < e.length; t++) e[t].call() }() }, 250) })
        };
    return {
        init: function(e) { e && e.breakpoints && (t = e.breakpoints), e && e.colors && (a = e.colors), n() },
        ...
        isInResponsiveRange: function(e) { var t = this.getViewPort().width; return "general" == e || ("desktop" == e && t >= this.getBreakpoint("lg") + 1 || ("tablet" == e && t >= this.getBreakpoint("md") + 1 && t < this.getBreakpoint("lg") || ("mobile" == e && t <= this.getBreakpoint("md") || ("desktop-and-tablet" == e && t >= this.getBreakpoint("md") + 1 || "tablet-and-mobile" == e && t <= this.getBreakpoint("lg"))))) },
        getUniqueID: function(e) { return e + Math.floor(Math.random() * (new Date).getTime()) },
        getBreakpoint: function(e) { if ($.inArray(e, t)) return t[e] },
        isset: function(e, t) {
            var a;
        ...
        hasFixedPositionedParent: function(e) { var t = !1; return e.parents().each(function() { "fixed" != $(this).css("position") || (t = !0) }), t },
        sleep: function(e) { for (var t = (new Date).getTime(), a = 0; a < 1e7 && !((new Date).getTime() - t > e); a++); },
        getRandomInt: function(e, t) { return Math.floor(Math.random() * (t - e + 1)) + e },
        getColor: function(e) { return a[e] },
        isAngularVersion: function() { return void 0 !== window.Zone }
    }
}();
$(document).ready(function() { mUtil.init() }), jQuery.fn.extend({
        animateClass: function(e, t) {
            var a = "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend";
            jQuery(this).addClass("animated " + e).one(a, function() { jQuery(this).removeClass("animated " + e) }), t && jQuery(this).one(a, t)
        },
        animateDelay: function(e) { for (var t = ["webkit-", "moz-", "ms-", "o-", ""], a = 0; a < t.length; a++) jQuery(this).css(t[a] + "animation-delay", e) },
        animateDuration: function(e) { for (var t = ["webkit-", "moz-", "ms-", "o-", ""], a = 0; a < t.length; a++) jQuery(this).css(t[a] + "animation-duration", e) }
    }),
    function(e) {
            ...
            if (!e(this).hasClass("m-datatable--loaded")) {
                ...
                var n = {
                    ...
                    extractTable: function() {
                        ...
                        t.columns = n;
                        var i = e(a).find("tr").get().map(function(t) { return e(t).find("td").get().map(function(t, a) { return e(t).html() }) }),
                            l = [];
                        e.each(i, function(t, a) {
                            if (0 !== a.length) {
                                var n = {};
                                e.each(a, function(e, t) { n[o[e]] = t }), l.push(n)
                            }
                        }), t.data.source = l
                    },
                    layoutUpdate: function() { n.setupSubDatatable.call(), n.setupSystemColumn.call(), n.columnHide.call(), n.sorting.call(), n.setupHover.call(), void 0 === t.detail && 1 === n.getDepth() && n.lockTable.call(), e(a).trigger("m-datatable--on-layout-updated", { table: e(a.table).attr("id") }) },
                    lockTable: function() {
                        var o = {
                            lockEnabled: !1,
                            init: function() { o.lockEnabled = e.grep(t.columns, function(e, t) { return void 0 !== e.locked && !1 !== e.locked }), 0 !== o.lockEnabled.length && (n.isLocked() || (a.oriTable = e(a.table).clone()), o.enable()) },
                            enable: function() {
                            ...
                            lockEnabledColumns: function() {
                                var a = e(window).width(),
                                    n = t.columns,
                                    o = { left: [], right: [] };
                                return e.each(n, function(e, t) { void 0 !== t.locked && (void 0 !== t.locked.left && mUtil.getBreakpoint(t.locked.left) <= a && o.left.push(t.locked.left), void 0 !== t.locked.right && mUtil.getBreakpoint(t.locked.right) <= a && o.right.push(t.locked.right)) }), o
                            }
                        };
                        return o.init(), o
                    },
                    ...
                    afterRender: function(t, i) { i.table === e(a.table).attr("id") && (n.isLocked() || o.redraw(), e(a).ready(function() { e(a.tableBody).find(".m-datatable__row:even").addClass("m-datatable__row--even"), n.isLocked() && o.redraw(), e(a.tableBody).css("visibility", ""), e(a.wrap).addClass("m-datatable--loaded"), n.scrollbar.call(), n.spinnerCallback(!1) })) },
                    setupHover: function() {
                    ...
                    dragResize: function() {
                        var t, n, o = !1,
                            i = void 0;
                        e(a.tableHead).find(".m-datatable__cell").mousedown(function(a) { i = e(this), o = !0, t = a.pageX, n = e(this).width(), e(i).addClass("m-datatable__cell--resizing") }).mousemove(function(l) {
                            if (o) {
                                var r = e(i).index(),
                                    s = e(a.tableBody),
                                ...
                                e(s).find(".m-datatable__row").each(function(a, o) { e(o).find(".m-datatable__cell").eq(r).width(n + (l.pageX - t)).children().width(n + (l.pageX - t)) }), e(i).children().width(n + (l.pageX - t))
                            }
                        }).mouseup(function() { e(i).removeClass("m-datatable__cell--resizing"), o = !1 }), e(document).mouseup(function() { e(i).removeClass("m-datatable__cell--resizing"), o = !1 })
                    },
                    initHeight: function() {
                    ...
                    setupTemplateCell: function(i) {
                        ...
                        e(i).find(".m-datatable__row").each(function(t, i) {
                            ...
                            "function" == typeof s && s(i, r, t), r.getIndex = function() { return t }, r.getDatatable = function() { return a }, void 0 === r && (r = {}, e(i).find(".m-datatable__cell").each(function(t, a) {
                                var n = e.grep(l, function(t, n) { return e(a).data("field") === t.field })[0];
                                void 0 !== n && (r[n.field] = e(a).text())
                            })), e(i).find(".m-datatable__cell").each(function(t, a) {
                                var o = e.grep(l, function(t, n) { return e(a).data("field") === t.field })[0];
                        ...
                        if (a.dataSet = a.dataSet || [], 0 !== a.dataSet.length) {
                            ...
                            e(a.tableBody).find(".m-datatable__row").each(function(t, a) {
                                e(a).find(".m-datatable__cell").each(function(t, a) {
                                    var i = e.grep(n, function(t, n) { return e(a).data("field") === t.field })[0];
                                    if (void 0 !== i) {
                                        var l = e(a).text();
                                        if (void 0 !== i.selector && !1 !== i.selector) {
                                            ...
                                            var r = e("<label/>").addClass("m-checkbox m-checkbox--single").append(e("<input/>").attr("type", "checkbox").attr("value", l).on("click", function() { e(this).is(":checked") ? o.setActive(this) : o.setInactive(this) })).append(e("<span/>"));
                            ...
                            var i = function(t) {
                                var a = e.grep(n, function(e, t) { return void 0 !== e.selector && !1 !== e.selector })[0];
                                if (void 0 !== a && void 0 !== a.selector && !1 !== a.selector) {
                                    ...
                                    var l = e("<label/>").addClass("m-checkbox m-checkbox--single m-checkbox--all").append(e("<input/>").attr("type", "checkbox").on("click", function() { e(this).is(":checked") ? o.setActiveAll(!0) : o.setActiveAll(!1) })).append(e("<span/>"));
                    ...
                    scrollbar: function() {
                        var i = {
                            ...
                            defaultScrollbar: function(t) { e(t).css("overflow", "auto").css("max-height", o.getOption("layout.height")).on("scroll", i.onScrolling) },
                            onScrolling: function(t) {
                                var a = e(this).scrollLeft(),
                                    n = e(this).scrollTop();
                                e(i.scrollHead).css("left", -a), e(i.scrollFoot).css("left", -a), e(i.tableLocked).each(function(t, a) { e(a).css("top", -n) })
                            },
                                ...
                                var r = e.extend({}, i.mcsOptions, {
                                    ...
                                    callbacks: {
                                        whileScrolling: function() {
                                            var t = this.mcs;
                                            e(i.scrollHead).css("left", t.left), e(i.scrollFoot).css("left", t.left), e(i.tableLocked).each(function(a, n) { e(n).css("top", t.top) })
                                        }
                                    }
                                });
                    ...
                    mCustomScrollbar: function(t, n) { e(a.tableBody).css("overflow", ""), 0 === e(t).find(".mCustomScrollbar").length && (e(a.tableBody).hasClass("mCustomScrollbar") && e(a.tableBody).mCustomScrollbar("destroy"), e(t).mCustomScrollbar(n)) },
                    ...
                    dataRender: function(i) {
                        ...
                        var l = function(i) {
                            e(a.wrap).removeClass("m-datatable--error"), t.pagination ? t.data.serverPaging && "local" !== t.data.type ? n.paging(n.getObject("meta", i || null)) : n.paging(function() {
                                ...
                                e(t.pager).hasClass("m-datatable--paging-loaded") || (e(t.pager).remove(), t.init(o)), e(t.pager).off().on("m-datatable--on-goto-page", function(a) { e(t.pager).remove(), t.init(o) });
                    ...
                    paging: function(t, i) {
                        var l = {
                            ...
                            populate: function() {
                                ...
                                e.each(o.getOption("toolbar.items.pagination.pageSizeSelect"), function(t, a) { var n = a; - 1 === a && (n = "All"), e("<option/>").attr("value", a).html(n).appendTo(m) }), e(a).ready(function() { e(".selectpicker").selectpicker().siblings(".dropdown-toggle").attr("title", o.getOption("translate.toolbar.pagination.items.default.select")) }), l.paste()
                            },
                            paste: function() { e.each(e.unique(o.getOption("toolbar.placement")), function(t, n) { "bottom" === n && e(l.pager).clone(!0).insertAfter(a.table), "top" === n && e(l.pager).clone(!0).addClass("m-datatable__pager--top").insertBefore(a.table) }) },
                            gotoMorePage: function(t) { if (t.preventDefault(), "disabled" === e(this).attr("disabled")) return !1; var a = e(this).attr("data-page"); return void 0 === a && (a = e(t.target).attr("data-page")), l.openPage(parseInt(a)), !1 },
                            gotoPage: function(t) { t.preventDefault(), e(this).hasClass("m-datatable__pager-link--active") || l.openPage(parseInt(e(this).data("page"))) },
                            openPage: function(t) { l.meta.page = parseInt(t), e(a).trigger(l.paginateEvent, l.meta), l.callback(l, l.meta), e(l.pager).trigger("m-datatable--on-goto-page", l.meta) },
                            updatePerpage: function(t) { t.preventDefault(), null === o.getOption("layout.height") && e("html, body").animate({ scrollTop: e(a).position().top }), l.pager = e(a.table).siblings(".m-datatable__pager").removeClass("m-datatable--paging-loaded"), t.originalEvent && (l.meta.perpage = parseInt(e(this).val())), e(l.pager).find("select.m-datatable__pager-size").val(l.meta.perpage).attr("data-selected", l.meta.perpage), o.setDataSourceParam("pagination", l.meta), e(l.pager).trigger("m-datatable--on-update-perpage", l.meta), e(a).trigger(l.paginateEvent, l.meta), l.callback(l, l.meta), l.updateInfo.call() },
                            ...
                            updateInfo: function() {
                                ...
                                e(l.pager).find(".m-datatable__pager-info").find(".m-datatable__pager-detail").html(n.dataPlaceholder(o.getOption("translate.toolbar.pagination.items.info"), { start: t, end: -1 === l.meta.perpage ? l.meta.total : a, pageSize: -1 === l.meta.perpage || l.meta.perpage >= l.meta.total ? l.meta.total : l.meta.perpage, total: l.meta.total }))
                            },
                    ...
                    columnHide: function() {
                        ...
                        e.each(t.columns, function(t, o) {
                            if (void 0 !== o.responsive) {
                                var i = o.field,
                                    l = e.grep(e(a.table).find(".m-datatable__cell"), function(t, a) { return i === e(t).data("field") });
                    ...
                    dataMapCallback: function(e) { var t = e; return "function" == typeof o.getOption("data.source.read.map") ? o.getOption("data.source.read.map")(e) : (void 0 !== e.data && (t = e.data), t) },
                    isSpinning: !1,
                    spinnerCallback: function(e) { if (e) { if (!n.isSpinning) { var t = o.getOption("layout.spinner");!0 === t.message && (t.message = o.getOption("translate.records.processing")), n.isSpinning = !0, void 0 !== mApp && mApp.block(a, t) } } else n.isSpinning = !1, void 0 !== mApp && mApp.unblock(a) },
                    ...
                    log: function(e, t) { void 0 === t && (t = ""), a.debug && console.log(e, t) },
                    isLocked: function() { return e(a.wrap).hasClass("m-datatable--lock") || !1 },
                    replaceTableContent: function(t, n) { void 0 === n && (n = a.tableBody), e(n).hasClass("mCustomScrollbar") ? e(n).find(".mCSB_container").html(t) : e(n).html(t) },
                    getExtraSpace: function(t) { return parseInt(e(t).css("paddingRight")) + parseInt(e(t).css("paddingLeft")) + (parseInt(e(t).css("marginRight")) + parseInt(e(t).css("marginLeft"))) + Math.ceil(e(t).css("border-right-width").replace("px", "")) },
                    dataPlaceholder: function(t, a) { var n = t; return e.each(a, function(e, t) { n = n.replace("{{" + e + "}}", t) }), n },
                    getTableId: function(t) { return void 0 === t && (t = ""), e(a).attr("id") + t },
                    getTablePrefix: function(e) { return void 0 !== e && (e = "-" + e), "m-datatable__" + n.getTableId() + "-" + n.getDepth() + e },
                    getDepth: function() {
                        var t = 0,
                            n = a.table;
                        do { n = e(n).parents(".m-datatable__table"), t++ } while (e(n).length > 0);
                        return t
                    },
                    stateKeep: function(e, t) { e = n.getTablePrefix(e), !1 !== o.getOption("data.saveState") && (o.getOption("data.saveState.webstorage") && localStorage && localStorage.setItem(e, JSON.stringify(t)), o.getOption("data.saveState.cookie") && Cookies.set(e, JSON.stringify(t))) },
                    stateGet: function(e, t) { if (e = n.getTablePrefix(e), !1 !== o.getOption("data.saveState")) { var a = null; return void 0 !== (a = o.getOption("data.saveState.webstorage") && localStorage ? localStorage.getItem(e) : Cookies.get(e)) && null !== a ? JSON.parse(a) : void 0 } },
                    stateUpdate: function(t, a) {
                        var o = n.stateGet(t);
                        void 0 !== o && null !== o || (o = {}), n.stateKeep(t, e.extend({}, o, a))
                    },
                    stateRemove: function(e) { e = n.getTablePrefix(e), localStorage && localStorage.removeItem(e), Cookies.remove(e) },
                    getTotalColumns: function(t) { return void 0 === t && (t = a.tableBody), e(t).find(".m-datatable__row").first().find(".m-datatable__cell").length },
                    getTotalRows: function(t) { return void 0 === t && (t = a.tableBody), e(t).find(".m-datatable__row").first().parent().find(".m-datatable__row").length },
                    getOneRow: function(t, a, n) { void 0 === n && (n = !0); var o = e(t).find(".m-datatable__row:not(.m-datatable__row-detail):nth-child(" + a + ")"); return n && (o = o.find(".m-datatable__cell")), o },
                    hasOverflowCells: function(t) {
                        var a = e(t).find("tr:first-child").find(".m-datatable__cell"),
                            n = 0;
                        return a.length > 0 && (e(a).each(function(t, a) { n += Math.ceil(e(a).innerWidth()) }), n >= e(t).outerWidth())
                    },
                    hasOverflowX: function(t) { var a = e(t).find("*"); if (a.length > 0) { return Math.max.apply(null, e(a).map(function() { return e(this).outerWidth(!0) }).get()) > e(t).width() } return !1 },
                    hasOverflowY: function(t) {
                        var a = e(t).find(".m-datatable__row"),
                            n = 0;
                        return a.length > 0 && (e(a).each(function(t, a) { n += Math.floor(e(a).innerHeight()) }), n > e(t).innerHeight())
                    },
                    ...
                    sorting: function() {
                        var i = {
                            init: function() { t.sortable && (e(a.tableHead).find(".m-datatable__cell:not(.m-datatable__cell--check)").addClass("m-datatable__cell--sort").off("click").on("click", i.sortClick), i.setIcon()) },
                            setIcon: function() {
                            ...
                            sortClick: function(l) {
                                ...
                                if ((void 0 === d.sortable || !1 !== d.sortable) && (e(a.tableHead).find(".m-datatable__cell > span > i").remove(), t.sortable)) {
                                    n.spinnerCallback(!0);
                                    var c = "desc";
                                    r.field === s && (c = r.sort), r = { field: s, sort: c = void 0 === c || "desc" === c ? "asc" : "desc" }, o.setDataSourceParam("sort", r), i.setIcon(), setTimeout(function() { n.dataRender("sort"), e(a).trigger("m-datatable--on-sort", r) }, 300)
                                }
                            }
                        };
                        i.init()
                    ...
                    localDataUpdate: function() {
                        ...
                        if (void 0 !== r ? "function" == typeof r.sortCallback ? a.dataSet = r.sortCallback(a.originalDataSet, l, r) : a.dataSet = n.sortCallback(a.originalDataSet, l, r) : a.dataSet = a.originalDataSet, "object" == typeof t.query) {
                            ...
                            void 0 !== s && "" !== s && (s = s.toLowerCase(), a.dataSet = e.grep(a.dataSet, function(e) {
                                ...
                                return !1
                            }), delete t.query[n.getGeneralSearchKey()]), e.each(t.query, function(e, a) { "" === a && delete t.query[e] }), a.dataSet = n.filterArray(a.dataSet, t.query), a.dataSet = a.dataSet.filter(function() { return !0 })
                        }
                        return a.dataSet
                    },
                    filterArray: function(t, a, n) {
                        ...
                        return e.each(t, function(t, l) {
                            var r = l,
                                s = 0;
                            e.each(a, function(e, t) { r.hasOwnProperty(e) && t == r[e] && s++ }), ("AND" == n && s == o || "OR" == n && s > 0 || "NOT" == n && 0 == s) && (i[t] = l)
                        }), t = i
                    },
                    resetScroll: function() { void 0 === t.detail && 1 === n.getDepth() && (e(a.table).find(".m-datatable__row").css("left", 0), e(a.table).find(".m-datatable__lock").css("top", 0), e(a.tableBody).scrollTop(0)) },
                    getColumnByField: function(a) { var n; return e.each(t.columns, function(e, t) { if (a === t.field) return n = t, !1 }), n },
                    getDefaultSortColumn: function() { var a = { sort: "", field: "" }; return e.each(t.columns, function(t, n) { if (void 0 !== n.sortable && -1 !== e.inArray(n.sortable, ["asc", "desc"])) return a = { sort: n.sortable, field: n.field }, !1 }), a },
                    getHiddenDimensions: function(t, a) {
                        ...
                        return i.each(function() {
                            ...
                            l.push(e)
                        }), o.width = e(t).width(), o.outerWidth = e(t).outerWidth(a), o.innerWidth = e(t).innerWidth(), o.height = e(t).height(), o.innerHeight = e(t).innerHeight(), o.outerHeight = e(t).outerHeight(a), i.each(function(e) { var t = l[e]; for (var a in n) this.style[a] = t[a] }), o
                    },
                    getGeneralSearchKey: function() { var t = e(o.getOption("search.input")); return e(t).prop("name") || e(t).prop("id") },
                    getObject: function(e, t) { return e.split(".").reduce(function(e, t) { return null !== e && void 0 !== e[t] ? e[t] : null }, t) },
                ...
                var o = {
                    timer: 0,
                    redraw: function() { return n.adjustCellsWidth.call(), n.adjustCellsHeight.call(), n.adjustLockContainer.call(), n.initHeight.call(), a },
                    load: function() { return o.reload(), a },
                    reload: function() { return function(e, t) { clearTimeout(o.timer), o.timer = setTimeout(e, t) }(function() {!1 === t.data.serverFiltering && n.localDataUpdate(), n.dataRender(), e(a).trigger("m-datatable--on-reloaded") }, o.getOption("search.delay")), a },
                    getRecord: function(t) { return void 0 === a.tableBody && (a.tableBody = e(a.table).children("tbody")), e(a.tableBody).find(".m-datatable__cell:first-child").each(function(o, i) { if (t == e(i).text()) { a.API.row = e(i).closest(".m-datatable__row"); var l = a.API.row.index() + 1; return a.API.record = a.API.value = n.getOneRow(a.tableBody, l), a } }), a },
                    getColumn: function(t) { return a.API.column = a.API.value = e(a.API.record).find('[data-field="' + t + '"]'), a },
                    destroy: function() { return e(a).parent().find(".m-datatable__pager").remove(), e(a).replaceWith(e(a.old).addClass("m-datatable--destroyed").show()), e(a).trigger("m-datatable--on-destroy"), a },
                    sort: function(t, n) { return void 0 === n && (n = "asc"), e(a.tableHead).find('.m-datatable__cell[data-field="' + t + '"]').trigger("click"), a },
                    getValue: function() { return e(a.API.value).text() },
                    ...
                    setActiveAll: function(t) { t ? o.setActive(e(a.table).find(".m-datatable__body .m-datatable__row").find(".m-datatable__cell")) : o.setInactive(e(a.table).find(".m-datatable__body .m-datatable__row").find(".m-datatable__cell")), e(a.table).find(".m-datatable__body .m-datatable__row").find('.m-checkbox [type="checkbox"]').prop("checked", t || !1) },
                    setSelectedRecords: function() { return a.API.record = e(a.tableBody).find(".m-datatable__row--active"), a },
                    getSelectedRecords: function() { return o.setSelectedRecords(), a.API.record },
                    getOption: function(e) { return n.getObject(e, t) },
                    setOption: function(e, a) { t = n.extendObj(t, e, a) },
                    search: function(a, i) {
                        void 0 !== i && (i = e.makeArray(i));
                        (function(e, t) { clearTimeout(o.timer), o.timer = setTimeout(e, t) })(function() {
                            var l = o.getDataSourceQuery();
                            if (void 0 === i && void 0 !== a) {
                                var r = n.getGeneralSearchKey();
                                l[r] = a
                            }
                            "object" == typeof i && (e.each(i, function(e, t) { l[t] = a }), e.each(l, function(e, t) { "" === t && delete l[e] })), o.setDataSourceQuery(l), !1 === t.data.serverFiltering && n.localDataUpdate(), n.dataRender()
                        }, o.getOption("search.delay"))
                    },
                    setDataSourceParam: function(t, i) {
                        var l = n.getDefaultSortColumn();
                        a.API.params = e.extend({}, { pagination: { page: 1, perpage: o.getOption("data.pageSize") }, sort: { sort: l.sort, field: l.field }, query: {} }, a.API.params, n.stateGet(n.stateId)), a.API.params = n.extendObj(a.API.params, t, i), n.stateKeep(n.stateId, a.API.params)
                    },
                    getDataSourceParam: function(t) { var i = n.getDefaultSortColumn(); return a.API.params = e.extend({}, { pagination: { page: 1, perpage: o.getOption("data.pageSize") }, sort: { sort: i.sort, field: i.field }, query: {} }, a.API.params, n.stateGet(n.stateId)), "string" == typeof t ? n.getObject(t, a.API.params) : a.API.params },
                    getDataSourceQuery: function() { return o.getDataSourceParam("query") || {} },
                    setDataSourceQuery: function(e) { o.setDataSourceParam("query", e) },
                    getCurrentPage: function() { return e(a.table).siblings(".m-datatable__pager").last().find(".m-datatable__pager-nav").find(".m-datatable__pager-link.m-datatable__pager-link--active").data("page") || 1 },
                    getPageSize: function() { return e(a.table).siblings(".m-datatable__pager").last().find(".m-datatable__pager-size").val() || 10 },
                    getTotalRows: function() { return a.API.params.pagination.total },
                    getDataSet: function() { return a.originalDataSet },
                    hideColumn: function(n) {
                        e.map(t.columns, function(e) { return n === e.field && (e.responsive = { hidden: "xl" }), e });
                        var o = e.grep(e(a.table).find(".m-datatable__cell"), function(t, a) { return n === e(t).data("field") });
                        e(o).hide()
                    },
                    showColumn: function(n) {
                        e.map(t.columns, function(e) { return n === e.field && delete e.responsive, e });
                        var o = e.grep(e(a.table).find(".m-datatable__cell"), function(t, a) { return n === e(t).data("field") });
                        e(o).show()
                    }
                };
                return e.each(o, function(e, t) { a[e] = t }), "string" == typeof t ? o[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? e.error("Method " + t + " does not exist") : (a.textAlign = { left: "m-datatable__cell--left", center: "m-datatable__cell--center", right: "m-datatable__cell--right" }, a.dataSet = null, t = e.extend(!0, {}, e.fn.mDatatable.defaults, t), e(a).data("options", t), e(a).trigger("m-datatable--on-init", t), n.init.apply(this, [t])), a
            }
        }, e.fn.mDatatable.defaults = { data: { type: "local", source: null, pageSize: 10, saveState: { cookie: !0, webstorage: !0 }, serverPaging: !1, serverFiltering: !1, serverSorting: !1 }, layout: { theme: "default", class: "m-datatable--brand", scroll: !1, height: null, footer: !1, header: !0, smoothScroll: { scrollbarShown: !0 }, spinner: { overlayColor: "#000000", opacity: 0, type: "loader", state: "brand", message: !0 }, icons: { sort: { asc: "la la-arrow-up", desc: "la la-arrow-down" }, pagination: { next: "la la-angle-right", prev: "la la-angle-left", first: "la la-angle-double-left", last: "la la-angle-double-right", more: "la la-ellipsis-h" }, rowDetail: { expand: "fa fa-caret-down", collapse: "fa fa-caret-right" } } }, sortable: !0, resizable: !1, filterable: !1, pagination: !0, editable: !1, columns: [], search: { input: null, delay: 400 }, rows: {}, toolbar: { layout: ["pagination", "info"], placement: ["bottom"], items: { pagination: { type: "default", pages: { desktop: { layout: "default", pagesNumber: 6 }, tablet: { layout: "default", pagesNumber: 3 }, mobile: { layout: "compact" } }, navigation: { prev: !0, next: !0, first: !0, last: !0 }, pageSizeSelect: [10, 20, 30, 50, 100] }, info: !0 } }, translate: { records: { processing: "Please wait...", noRecords: "No records found" }, toolbar: { pagination: { items: { default: { first: "First", prev: "Previous", next: "Next", last: "Last", more: "More pages", input: "Page number", select: "Select page size" }, info: "Displaying {{start}} - {{end}} of {{total}} records" } } } } }
    }(jQuery),
    function(e) {
        e.fn.mDropdown = function(t) {
            var a = {},
                n = e(this),
                o = {
                    run: function(e) { return n.data("dropdown") ? a = n.data("dropdown") : (o.init(e), o.build(), o.setup(), n.data("dropdown", a)), a },
                    init: function(t) { a.events = [], a.eventOne = !1, a.close = n.find(".m-dropdown__close"), a.toggle = n.find(".m-dropdown__toggle"), a.arrow = n.find(".m-dropdown__arrow"), a.wrapper = n.find(".m-dropdown__wrapper"), a.scrollable = n.find(".m-dropdown__scrollable"), a.defaultDropPos = n.hasClass("m-dropdown--up") ? "up" : "down", a.currentDropPos = a.defaultDropPos, a.options = e.extend(!0, {}, e.fn.mDropdown.defaults, t), !0 === n.data("drop-auto") ? a.options.dropAuto = !0 : !1 === n.data("drop-auto") && (a.options.dropAuto = !1), a.scrollable.length > 0 && (a.scrollable.data("min-height") && (a.options.minHeight = a.scrollable.data("min-height")), a.scrollable.data("max-height") && (a.options.maxHeight = a.scrollable.data("max-height"))) },
                    build: function() { mUtil.isMobileDevice() ? "hover" == n.data("dropdown-toggle") || "click" == n.data("dropdown-toggle") ? a.options.toggle = "click" : (a.options.toggle = "click", a.toggle.click(o.toggle)) : "hover" == n.data("dropdown-toggle") ? (a.options.toggle = "hover", n.mouseleave(o.hide)) : "click" == n.data("dropdown-toggle") ? a.options.toggle = "click" : "hover" == a.options.toggle ? (n.mouseenter(o.show), n.mouseleave(o.hide)) : a.toggle.click(o.toggle), a.close.length && a.close.on("click", o.hide), o.disableClose() },
                    setup: function() { a.options.placement && n.addClass("m-dropdown--" + a.options.placement), a.options.align && n.addClass("m-dropdown--align-" + a.options.align), a.options.width && a.wrapper.css("width", a.options.width), n.data("dropdown-persistent") && (a.options.persistent = !0), a.options.minHeight && a.scrollable.css("min-height", a.options.minHeight), a.options.maxHeight && (a.scrollable.css("max-height", a.options.maxHeight), a.scrollable.css("overflow-y", "auto"), mUtil.isDesktopDevice() && mApp.initScroller(a.scrollable, {})), o.setZindex() },
                    sync: function() { e(n).data("dropdown", a) },
                    disableClose: function() { n.on("click", ".m-dropdown--disable-close, .mCSB_1_scrollbar", function(e) { e.preventDefault(), e.stopPropagation() }) },
                    toggle: function() { return a.open ? o.hide() : o.show() },
                    setContent: function(e) { return n.find(".m-dropdown__content").html(e), a },
                    show: function() {
                        ...
                        if (a.arrow.length > 0 && o.adjustArrowPos(), o.eventTrigger("beforeShow"), o.hideOpened(), n.addClass("m-dropdown--open"), mUtil.isMobileDevice() && a.options.mobileOverlay) {
                            ...
                            i.css("zIndex", t), i.data("dropdown", n), n.data("dropoff", i), n.after(i), i.click(function(t) { o.hide(), e(this).remove(), t.preventDefault() })
                        }
                    ...
                    hideHovered: function(e) {
                        if (e) {
                            ...
                            if (!1 === o.eventTrigger("beforeHide")) return;
                            var t = setTimeout(function() { n.data("hover") && (o.clearHovered(), n.removeClass("m-dropdown--open"), a.open = !1, o.eventTrigger("afterHide")) }, a.options.hoverTimeout);
                            n.data("hover", !0), n.data("timeout", t)
                        }
                    },
                    hideClicked: function() {!1 !== o.eventTrigger("beforeHide") && (n.removeClass("m-dropdown--open"), n.data("dropoff") && n.data("dropoff").remove(), a.open = !1, o.eventTrigger("afterHide")) },
                    hide: function(e) { return !1 === a.open ? a : ("hover" == a.options.toggle ? o.hideHovered(e) : o.hideClicked(), "down" == a.defaultDropPos && "up" == a.currentDropPos && (n.removeClass("m-dropdown--up"), a.arrow.prependTo(a.wrapper), a.currentDropPos = "down"), a) },
                    hideOpened: function() { e(".m-dropdown.m-dropdown--open").each(function() { e(this).mDropdown().hide(!0) }) },
                    ...
                    eventTrigger: function(e) { for (i = 0; i < a.events.length; i++) { var t = a.events[i]; if (t.name == e) { if (1 != t.one) return t.handler.call(this, a); if (0 == t.fired) return a.events[i].fired = !0, t.handler.call(this, a) } } },
                    addEvent: function(e, t, n) { return a.events.push({ name: e, handler: t, one: n, fired: !1 }), o.sync(), a }
                };
            return o.run.apply(this, [t]), a.show = function() { return o.show() }, a.hide = function() { return o.hide() }, a.toggle = function() { return o.toggle() }, a.isPersistent = function() { return o.isPersistent() }, a.isShown = function() { return o.isShown() }, a.fixDropPosition = function() { return o.handleDropPosition() }, a.setContent = function(e) { return o.setContent(e) }, a.on = function(e, t) { return o.addEvent(e, t) }, a.one = function(e, t) { return o.addEvent(e, t, !0) }, a
        }, e.fn.mDropdown.defaults = { toggle: "click", hoverTimeout: 300, skin: "default", height: "auto", dropAuto: !0, maxHeight: !1, minHeight: !1, persistent: !1, mobileOverlay: !0 }, mUtil.isMobileDevice() ? e(document).on("click", '[data-dropdown-toggle="click"] .m-dropdown__toggle, [data-dropdown-toggle="hover"] .m-dropdown__toggle', function(t) { t.preventDefault(), e(this).parent(".m-dropdown").mDropdown().toggle() }) : (e(document).on("click", '[data-dropdown-toggle="click"] .m-dropdown__toggle', function(t) { t.preventDefault(), e(this).parent(".m-dropdown").mDropdown().toggle() }), e(document).on("mouseenter", '[data-dropdown-toggle="hover"]', function(t) { e(this).mDropdown().toggle() })), e(document).on("click", function(t) {
    ...
    function(e) {
        e.fn.mHeader = function(t) {
            var a = this,
                n = e(this),
                o = {
                    run: function(e) { return n.data("header") ? a = n.data("header") : (o.init(e), o.reset(), o.build(), n.data("header", a)), a },
                    init: function(t) { a.options = e.extend(!0, {}, e.fn.mHeader.defaults, t) },
                    build: function() { o.toggle() },
                    toggle: function() {
                        var t = 0;
        ...
        e.fn.mMenu = function(t) {
            var a = this,
                ...
                o = {
                    ...
                    handleLinkClick: function(t) {!1 === o.eventTrigger("linkClick", e(this)) && t.preventDefault(), ("dropdown" === o.getSubmenuMode() || o.isConditionalSubmenuDropdown()) && o.handleSubmenuDropdownClose(t, e(this)) },
                    ...
                    handleSubmenuDrodownHoverExit: function(t) {
                        if (!1 !== a.resumeDropdownHover() && "accordion" !== o.getSubmenuMode()) {
                            var n = e(this),
                                ...
                                l = setTimeout(function() { 1 == n.data("hover") && o.hideSubmenuDropdown(n, !0) }, i);
                    ...
                    handleSubmenuDropdownClose: function(t, a) {
                        if ("accordion" !== o.getSubmenuMode()) {
                            ...
                            i.length > 0 && !1 === a.hasClass("m-menu__toggle") && 0 === a.find(".m-menu__toggle").length && i.each(function() { o.hideSubmenuDropdown(e(this), !0) })
                        }
                    },
                            ...
                            if (l.parent(".m-menu__item--expanded").length, l.length > 0) {
                                ...
                                if (!1 === i.hasClass("m-menu__item--open")) {
                                    if (!1 === a.options.accordion.expandAll) {
                                        ...
                                        s.each(function() { e(this).children(".m-menu__submenu").slideUp(r, function() { o.scrollToItem(n) }), e(this).removeClass("m-menu__item--open") }), s.length > 0 && !0
                                    }
                                    l.slideDown(r, function() { o.scrollToItem(n) }), i.addClass("m-menu__item--open")
                                } else l.slideUp(r, function() { o.scrollToItem(n) }), i.removeClass("m-menu__item--open")
                            }
                        } else t.preventDefault()
                    },
                    scrollToItem: function(e) { mUtil.isInResponsiveRange("desktop") && a.options.accordion.autoScroll && !n.data("menu-scrollable") && mApp.scrollToViewport(e) },
                    ...
                    createSubmenuDropdownClickDropoff: function(t) {
                        ...
                        e("body").after(n), n.on("click", function(a) { a.stopPropagation(), a.preventDefault(), t.removeClass("m-menu__item--hover"), e(this).remove() })
                    },
                    ...
                    resetActiveItem: function(t) { n.find(".m-menu__item--active").each(function() { e(this).removeClass("m-menu__item--active"), e(this).children(".m-menu__submenu").css("display", ""), e(this).parents(".m-menu__item--submenu").each(function() { e(this).removeClass("m-menu__item--open"), e(this).children(".m-menu__submenu").css("display", "") }) }), !1 === a.options.accordion.expandAll && n.find(".m-menu__item--open").each(function() { e(this).removeClass("m-menu__item--open") }) },
                    setActiveItem: function(t) {
                        o.resetActiveItem();
                        (t = e(t)).addClass("m-menu__item--active"), t.parents(".m-menu__item--submenu").each(function() { e(this).addClass("m-menu__item--open") })
                    },
                    getBreadcrumbs: function(t) {
                        var a = [],
                            n = (t = e(t)).children(".m-menu__link");
                        return a.push({ text: n.find(".m-menu__link-text").html(), title: n.attr("title"), href: n.attr("href") }), t.parents(".m-menu__item--submenu").each(function() {
                            var t = e(this).children(".m-menu__link");
                            a.push({ text: t.find(".m-menu__link-text").html(), title: t.attr("title"), href: t.attr("href") })
                        }), a.reverse(), a
                    },
                    getPageTitle: function(t) { return (t = e(t)).children(".m-menu__link").find(".m-menu__link-text").html() },
                    sync: function() { e(n).data("menu", a) },
                    eventTrigger: function(e, t) { for (i = 0; i < a.events.length; i++) { var n = a.events[i]; if (n.name == e) { if (1 != n.one) return n.handler.call(this, a, t); if (0 == n.fired) return a.events[i].fired = !0, n.handler.call(this, a, t) } } },
                    addEvent: function(e, t, n) { a.events.push({ name: e, handler: t, one: n, fired: !1 }), o.sync() }
                };
            return o.run.apply(a, [t]), void 0 !== t && e(window).resize(function() { o.run.apply(a, [t, !0]) }), a.setActiveItem = function(e) { return o.setActiveItem(e) }, a.getBreadcrumbs = function(e) { return o.getBreadcrumbs(e) }, a.getPageTitle = function(e) { return o.getPageTitle(e) }, a.getSubmenuMode = function() { return o.getSubmenuMode() }, a.pauseDropdownHover = function(e) { o.pauseDropdownHover(e) }, a.resumeDropdownHover = function() { return o.resumeDropdownHover() }, a.on = function(e, t) { return o.addEvent(e, t) }, a
        }, e.fn.mMenu.defaults = { accordion: { slideSpeed: 200, autoScroll: !0, expandAll: !0 }, dropdown: { timeout: 500 } }, e(document).on("click", function(t) {
                    ...
                    show: function() {
                        if ("shown" != a.state) {
                            if (o.eventTrigger("beforeShow"), "" != a.toggleState && e(a.toggleTarget).addClass(a.toggleState), e("body").addClass(a.classShown), n.addClass(a.classShown), a.state = "shown", a.options.overlay) {
                                ...
                                n.after(t), a.overlay = t, a.overlay.on("click", function(e) { e.stopPropagation(), e.preventDefault(), o.hide() })
                            }
                            return o.eventTrigger("afterShow"), a
                        }
                    },
                    hide: function() { if ("hidden" != a.state) return o.eventTrigger("beforeHide"), "" != a.toggleState && e(a.toggleTarget).removeClass(a.toggleState), e("body").removeClass(a.classShown), n.removeClass(a.classShown), a.state = "hidden", a.options.overlay && a.overlay.remove(), o.eventTrigger("afterHide"), a },
                    eventTrigger: function(e) { for (i = 0; i < a.events.length; i++) { var t = a.events[i]; if (t.name == e) { if (1 != t.one) return t.handler.call(this, a); if (0 == t.fired) return a.events[i].fired = !0, t.handler.call(this, a) } } },
                    addEvent: function(e, t, n) { a.events.push({ name: e, handler: t, one: n, fired: !1 }), o.sync() }
                };
            return o.run.apply(this, [t]), a.hide = function() { return o.hide() }, a.show = function() { return o.show() }, a.on = function(e, t) { return o.addEvent(e, t) }, a.one = function(e, t) { return o.addEvent(e, t, !0) }, a
    ...
    function(e) {
        e.fn.mPortlet = function(t) {
            var a = {},
                n = e(this),
                o = {
                    run: function(e) { return n.data("portlet-object") ? a = n.data("portlet-object") : (o.init(e), o.build(), n.data("portlet-object", a)), a },
                    init: function(t) { a.options = e.extend(!0, {}, e.fn.mPortlet.defaults, t), a.events = [], a.eventOne = !1, 0 !== n.find("> .m-portlet__body").length ? a.body = n.find("> .m-portlet__body") : 0 !== n.find("> .m-form").length && (a.body = n.find("> .m-form")) },
                    build: function() {
                        var e = n.find("> .m-portlet__head [data-portlet-tool=remove]");
                        1 === e.length && e.click(function(e) { e.preventDefault(), o.remove() });
                        var t = n.find("> .m-portlet__head [data-portlet-tool=reload]");
                        1 === t.length && t.click(function(e) { e.preventDefault(), o.reload() });
                        var a = n.find("> .m-portlet__head [data-portlet-tool=toggle]");
                        1 === a.length && a.click(function(e) { e.preventDefault(), o.toggle() });
                        var i = n.find("> .m-portlet__head [data-portlet-tool=fullscreen]");
                        1 === i.length && i.click(function(e) { e.preventDefault(), o.fullscreen() }), o.setupTooltips()
                    },
                    remove: function() {!1 !== o.eventTrigger("beforeRemove") && (e("body").hasClass("m-portlet--fullscreen") && n.hasClass("m-portlet--fullscreen") && o.fullscreen("off"), o.removeTooltips(), n.remove(), o.eventTrigger("afterRemove")) },
                    setContent: function(e) { e && a.body.html(e) },
                    ...
                    toggle: function(e) {
                        if ("collapse" === e || n.hasClass("m-portlet--collapse") || n.hasClass("m-portlet--collapsed")) {
                            ...
                            n.removeClass("m-portlet--collapse"), n.removeClass("m-portlet--collapsed"), o.setupTooltips(), a.body.slideDown(a.options.bodyToggleSpeed, function() { o.eventTrigger("afterExpand") })
                        } else {
                            if (!1 === o.eventTrigger("beforeCollapse")) return;
                            n.addClass("m-portlet--collapse"), o.setupTooltips(), a.body.slideUp(a.options.bodyToggleSpeed, function() { o.eventTrigger("afterCollapse") })
                        }
                    },
                    fullscreen: function(t) { "off" === t || e("body").hasClass("m-portlet--fullscreen") && n.hasClass("m-portlet--fullscreen") ? (o.eventTrigger("beforeFullscreenOff"), e("body").removeClass("m-portlet--fullscreen"), n.removeClass("m-portlet--fullscreen"), o.setupTooltips(), o.eventTrigger("afterFullscreenOff")) : (o.eventTrigger("beforeFullscreenOn"), n.addClass("m-portlet--fullscreen"), e("body").addClass("m-portlet--fullscreen"), o.setupTooltips(), o.eventTrigger("afterFullscreenOn")) },
                    sync: function() { e(n).data("portlet", a) },
                    eventTrigger: function(e) { for (i = 0; i < a.events.length; i++) { var t = a.events[i]; if (t.name == e) { if (1 != t.one) return t.handler.call(this, a); if (0 == t.fired) return a.events[i].fired = !0, t.handler.call(this, a) } } },
                    addEvent: function(e, t, n) { return a.events.push({ name: e, handler: t, one: n, fired: !1 }), o.sync(), a }
                };
            return o.run.apply(this, [t]), a.remove = function() { return o.remove(html) }, a.reload = function() { return o.reload() }, a.setContent = function(e) { return o.setContent(e) }, a.collapse = function() { return o.toggle("collapse") }, a.expand = function() { return o.toggle("expand") }, a.fullscreen = function() { return o.fullscreen("on") }, a.unFullscreen = function() { return o.fullscreen("off") }, a.getBody = function() { return o.getBody() }, a.getSelf = function() { return o.getSelf() }, a.on = function(e, t) { return o.addEvent(e, t) }, a.one = function(e, t) { return o.addEvent(e, t, !0) }, a
        }, e.fn.mPortlet.defaults = { bodyToggleSpeed: 400, tooltips: false, tools: { toggle: { collapse: "Colapsar", expand: "Expand" }, reload: "Reload", remove: "Remove", fullscreen: { on: "Fullscreen", off: "Exit Fullscreen" } } }
    }(jQuery),
    function(e) {
    ...
    function(e) {
        ...
        highlight: function(e) { $(e).closest(".form-group").addClass("has-danger"), $(e).hasClass("form-control") },
        unhighlight: function(e) { $(e).closest(".form-group").removeClass("has-danger") },
        success: function(e, t) { $(e).closest(".form-group").addClass("has-success").removeClass("has-danger"), $(e).closest(".form-group").find(".form-control-feedback").remove() }
    });
    ...
    return {
        ...
        initAside: function() {
            ! function() {
                ...
                a = $("#m_aside_left").mOffcanvas({ class: e, overlay: !0, close: "#m_aside_left_close_btn", toggle: { target: "#m_aside_left_offcanvas_toggle", state: "m-brand__toggler--active" } })
            }(),
            function() {
                function e(e) {
                ...
                var a = $("#m_ver_menu"),
                    n = { submenu: { desktop: { default: (a.data("menu-dropdown"), "accordion"), state: { body: "m-aside-left--minimize", mode: "accordion" } }, tablet: "accordion", mobile: "accordion" }, accordion: { autoScroll: !1, expandAll: !1 } };
                t = a.mMenu(n), a.data("menu-scrollable") && (e(t), mUtil.addResizeHandler(function() { e(t) }))
            }(), $("#m_aside_left_minimize_toggle").mToggle({ target: "body", targetState: "m-brand--minimize m-aside-left--minimize", togglerState: "m-brand__toggler--active" }).on("toggle", function() { e.pauseDropdownHover(800), t.pauseDropdownHover(800) }), $("#m_aside_left_hide_toggle").mToggle({ target: "body", targetState: "m-aside-left--hide", togglerState: "m-brand__toggler--active" }).on("toggle", function() { e.pauseDropdownHover(800), t.pauseDropdownHover(800) })
        },
...
var mQuickSidebar = function() {
    ...
    return { init: function() { e.mOffcanvas({ class: "m-quick-sidebar", close: a, toggle: n }), e.mOffcanvas().one("afterShow", function() { mApp.block(e), setTimeout(function() { mApp.unblock(e), o.removeClass("m--hide"), i() }, 1e3) }) } }
}();
